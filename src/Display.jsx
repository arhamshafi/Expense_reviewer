...
function Display() {
    ...
    return (
        <div className='pb-12'>
            <div className='w-[90%] h-[200px] mx-auto mt-12 rounded-2xl overflow-hidden bshb bg-[url("/src/horse.jpg")] bg-cover bg-center relative'>
            ...
            <div className='w-[90%] h-max flex flex-wrap  justify-between px-3 items-center mx-auto overflow-hidden py-2 mt-8  rounded-xl'>
                ...
                <div className={`w-full sm:w-[47%] lg:w-[30%] rounded-xl  h-[300px] order-1 sm:order-1 md:order-1 lg:order-1 relative ${darkmod ? "bg-white bshb" : "bg-blue-100 bshb2"} transition-all duration-all ease-linear`}>
                ...
                <div className={`w-full lg:w-[30%]  bshb h-[300px]  p-3 mt-8 lg:mt-0 order-2 sm:order-3 md:order-3 lg:order-2 rounded-xl ${darkmod ? "bg-black" : "bg-white"} transition-all duration-300 ease-linear`}>
                ...
                <div className={` w-full sm:w-[50%] md:w-[47%] lg:w-[30%] h-[300px] mt-8 sm:mt-0 lg:mt-0 order-3 sm:order-2 md:order-2 lg:order-3 flex justify-center bshb ${darkmod ? "bg-white" : "bg-black"} rounded-xl items-center`}> <Calender /> </div>
            </div>
        </div>
    )
}
